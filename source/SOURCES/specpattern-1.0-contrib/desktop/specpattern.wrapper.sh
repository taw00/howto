...
# Specpattern is a simple example application unaffected by these issues, but I
...
XDG_CURRENT_DESKTOP=$_XDG_CURRENT_DESKTOP XDG_SESSION_TYPE=$_XDG_SESSION_TYPE QT_QPA_PLATFORM=$_QT_QPA_PLATFORM /usr/bin/env specpattern
